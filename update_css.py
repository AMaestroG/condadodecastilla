...
# Define the regex to match the sidebar-toggle block
# We match from .sidebar-toggle { up to the closing brace, assuming indentation
pattern = r'\.sidebar-toggle\s*\{[^}]+\}'

# New CSS content
new_css = """/* Header Controls & Toggles */
.header-controls {
  z-index: 10001;
}
